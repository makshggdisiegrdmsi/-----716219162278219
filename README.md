-- Script original com alterações VISUAIS apenas:
-- - bordas arredondadas
...
-- Função para tentar usar CoreGui; se não for possível, usa PlayerGui
...
-- inicializa UI / botao se autorizado (comportamento original mantido)
